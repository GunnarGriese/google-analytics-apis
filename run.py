...
service_config = GoogleOAuth(
    ...
    CLIENT_SECRET_PATH = "credentials/gunnar_project.json", 
...
# Build service
api_service = AnalyticsManagement(service_config, account_id="152079293", property_id="UA-152079293-1", view_id="205698058")
